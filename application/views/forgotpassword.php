...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>assets/examples/css/pages/register-v3.css">
    <!-- Fonts -->
    ...
    <div class="page-content vertical-align-middle animation-slide-top animation-duration-1">
        <div class="panel">
            <div class="panel-body">
                <div class="brand">
                    <img class="brand-img" src="<?= base_url() ?>assets/logo/logolapan.png" width="45%" width="45%" alt="...">
                    <h2 class="brand-text font-size-18">Form Lupa Password</h2>
                </div>
                <form method="post" action="<?= base_url('auth/forgot_password'); ?>">
                    ...
                    <div class="row">
                        ...
                        Email
                        <input type="email" class="form-control mb-15 mr-10" name="email" id="email" placeholder="Masukkan Email">
                        <small class="form-text text-danger"><?= form_error('email'); ?></small>

                        <button style="cursor:pointer;" type="submit" class="btn btn-primary btn-block btn-lg mt-10">Submit</button>
                </form>

            </div>
            <p><a href="<?= base_url('auth'); ?>">Kembali</a></p>
        </div>
    </div>
